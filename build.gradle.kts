...
intellijPlatform {
    ...
    // ./gradlew verifyPlugin catches API differences between IDE versions before an upload does
    pluginVerification {
        ides {
            ...
            ide(org.jetbrains.intellij.platform.gradle.IntelliJPlatformType.IntellijIdeaUltimate, "2026.2.3")
        }
    }
}
